...
namespace Wu_Xing
{
    class Soul : Enemy
    {
        public Soul(Vector2 position, Element element, Random random) : base(position, element, random)
        {
            ...
            origin = source.Size.ToVector2() / 2 + new Vector2(0, 0);
            animationFPS = 60;
            MoveTo(position);
        ...
        public override void Draw(SpriteBatch spriteBatch, Vector2 roomPosition, bool drawHitbox)
        {
            ...
            spriteBatch.Draw(TextureLibrary.ElementalEyes, roomPosition + position + new Vector2(0, 0), null, Color.White, 0, origin, 1, SpriteEffects.None, layerDepth + 0.001f);
        }
    }
}
